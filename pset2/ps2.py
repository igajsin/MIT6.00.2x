...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        height: an integer > 0
        """
        assert width > 0, "Width should be great than zero."
        assert height > 0, "Hight should be great than zero."
        self.width = width
        self.height = height
        self.tiles = {}
    ...
    def isTileCleaned(self, m, n):
        ...
        """
        assert m < self.width, "m should be less than Width"
        assert n < self.height, "n should be less than Height"
